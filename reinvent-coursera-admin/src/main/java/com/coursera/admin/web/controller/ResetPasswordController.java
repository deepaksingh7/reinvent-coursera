...
import com.coursera.admin.web.service.ResetPasswordRequest;
import com.google.common.base.Strings;

/**
 * ResetPasswordController This controller handles the reset password form. This
 * form is used to reset the password using a code that is emailed to the user's
 * email address.
 */
@Controller
		...
		if (!hasErrors) {
			try {
				...
				redirect.addFlashAttribute("reset_password_error",
						"Error encountered reseting password: " + e.getLocalizedMessage());
			}
		}
		return nextPage;
	}
