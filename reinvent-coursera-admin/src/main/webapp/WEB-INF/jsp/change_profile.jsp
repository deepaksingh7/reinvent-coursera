...
<title>Coursera Admin: Change Profile Information</title>
</head>
<body>
			...
			<div class="w3-bar w3-blue">
				...
				<div class="login100_form validate-form">
					...
					<div class="wrap-input100 ">
						...
						<div class="login100-form-title p-t-20">Change Location	Information</div>

						<c:if
							test="${change_password_error != null && change_password_error.length() > 0}">
							<span class="login100-form-title p-b-34 inputError">
								${change_password_error}</span>
						</c:if>

						<form action="<c:url value="/change_profile_form" />" method="post"
							style="margin: 10px;">
							<!-- Location -->
							<c:if
								test="${location_error != null && location_error.length() > 0}">
								<span class="login100-form-title p-b-34 inputError">${location_error}</span>
							</c:if>

							<div class="form-group row">
								<select class="custom-select col-sm-8" name="location"
									id="location">
