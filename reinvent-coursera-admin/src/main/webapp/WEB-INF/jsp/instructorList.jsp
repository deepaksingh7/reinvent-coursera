...
<title>Coursera Admin: Instructor</title>
</head>
<body>
	<div class="limiter">
			...
			<div class="wrap-login100">
				...
				<div class="login100_form validate-form">
					...
					<div class="wrap-input100 ">
					  <div class="login100-form-title p-b-20 p-t-20" style="padding-bottom:-20px"> Here are the list of Instructors:</div>
					  ...
					  <c:if test="${errorMessage != null && errorMessage.length() > 0}">
							...
							<div class="input100 p-t-20"> 							
								...
								<hr>
									<p class="p-t-10">${listValue.firstName} ${listValue.lastName}  : ${listValue.email} </p> 
									<p class="p-t-10">${listValue.occupation}</p>
									<p class="p-t-10">${listValue.description}</p>
									<p class="p-t-10">
										<form action="<c:url value="/delete_instructor_form" />" method="post" style="display: inline">
										...
										<form action="<c:url value="/instructor/${listValue.instructorId}" />"  style="display: inline">
										<button class="formButton">Update</button></form>
									</p>
								</c:forEach>
							</div>
							<form action="<c:url value="/addinstructors" />" style="margin:10px;">
							<div class="p-t-10">
								<span>
									<button type="submit" class="login100-form-btn">Add Instructor</button>
								</span>
						</div>
						</form>
					 </div>
