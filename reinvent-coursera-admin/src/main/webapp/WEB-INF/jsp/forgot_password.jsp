...
<title>Coursera Admin: Reset your password</title>
</head>
<body>
	<div class="limiter">
			...
			<!-- Navigation Menu -->
				...
				<div class="login100_form validate-form">
					<div class="wrap-input100 ">
						<div class="login100-form-title p-t-20">Reset your password</div>
						<!-- Post to login form -->
						<form action="<c:url value="/forgot_password_form" />" method="post" style="margin:10px;">
