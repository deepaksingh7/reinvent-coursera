...
<title>Coursera Admin: Add Category</title>
</head>
<body>
	<div class="limiter">
			...
			<div class="wrap-login100">
				...
				<div class="login100_form validate-form">
					<div class="wrap-input100 ">
					  <div class="login100-form-title p-b-20 p-t-20" style="padding-bottom:-20px">Add Category</div>
					  <form action="<c:url value="/add_category_form" />" method="post" style="margin: 10px;">
							<div class="input100 p-t-20"> 							
								<hr>
									<p class="wrap-input100 m-b-20">
									<input type="text" id="categoryName" name="categoryName" class="input100" placeholder="categoryName">
									  </p> 
							</div>
